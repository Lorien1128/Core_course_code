...
LAB58:    if (*((unsigned int *)t104) > 0)
        goto LAB59;

LAB60:    if (*((unsigned int *)t95) > 0)
        goto LAB61;

LAB62:    memcpy(t94, t113, 8);

LAB63:    goto LAB45;

LAB46:    xsi_vlog_unsigned_bit_combine(t76, 32, t89, 32, t94, 32);
    goto LAB50;

LAB48:    memcpy(t76, t89, 8);
    goto LAB50;
...
LAB59:    xsi_vlog_unsigned_bit_combine(t94, 32, t108, 32, t113, 32);
    goto LAB63;

LAB61:    memcpy(t94, t108, 8);
    goto LAB63;
...
LAB20:    t150 = (t0 + 4480);
    ...
    t154 = *((char **)t153);
    memcpy(t154, t3, 8);
    xsi_driver_vfirst_trans(t150, 0, 31);
    t155 = (t0 + 4320);
    *((int *)t155) = 1;
...
LAB43:    memcpy(t101, t80, 8);

LAB44:    memset(t78, 0, 8);
    t129 = (t101 + 4);
...
LAB59:    if (*((unsigned int *)t136) > 0)
        goto LAB60;

LAB61:    if (*((unsigned int *)t78) > 0)
        goto LAB62;

LAB63:    memcpy(t77, t149, 8);
...
LAB56:    t140 = (t0 + 1368U);
    ...
    t140 = ((char*)((ng2)));
    memset(t142, 0, 8);
    xsi_vlog_unsigned_minus(t142, 32, t141, 32, t140, 32);
    goto LAB57;
...
LAB58:    t147 = (t0 + 1368U);
    ...
    t147 = ((char*)((ng2)));
    memset(t149, 0, 8);
    xsi_vlog_unsigned_minus(t149, 32, t148, 32, t147, 32);
    goto LAB59;

LAB60:    xsi_vlog_unsigned_bit_combine(t77, 32, t142, 32, t149, 32);
    goto LAB64;

LAB62:    memcpy(t77, t142, 8);
    goto LAB64;
...
extern void work_m_00000000002179311827_0299380779_init()
{
	static char *pe[] = {(void *)Cont_87_0,(void *)Cont_92_1,(void *)Cont_97_2};
	xsi_register_didat("work_m_00000000002179311827_0299380779", "isim/mips_txt_isim_beh.exe.sim/work/m_00000000002179311827_0299380779.didat");
